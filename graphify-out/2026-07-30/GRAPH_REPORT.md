# Graph Report - jsvcc80  (2026-07-30)

## Corpus Check
- 163 files · ~171,408 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1366 nodes · 2587 edges · 128 communities (63 shown, 65 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 6 edges (avg confidence: 0.83)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `c8a2e248`
...
6. `seq()` - 28 edges
7. `lazy()` - 26 edges
8. `LexerCore` - 25 edges
9. `PreprocessedSource` - 25 edges
...
Cohesion: 0.08
Nodes (12): AttributeNode, BinaryOpNode, EnumNode, EnumValueNode, FunctionPointerCallNode, InitializerNode, InlineAsmNode, LabelNode (+4 more)
...
Cohesion: 0.10
Nodes (5): AttributeHandler, IREmissionPass, PluginLoader, PreprocessorExtension, SemanticsPass

### Community 8 - "Z80 Code Generator"
Cohesion: 0.07
Nodes (5): Z80Codegen, computeFieldOffsets(), computeStructSize(), TypeRegistry, compileToAssembly()
...
Cohesion: 0.10
Nodes (8): makeLocation(), AnyParser, LitParser, ManyParser, OptParser, PredParser, SomeParser, withLocation()
...
Cohesion: 0.06
Nodes (18): Registers, CompilerOptions, AstToIr, CPegParser, buildStatement(), buildStatementList(), kw(), locFromToken() (+10 more)
...
- **Why does `ProgramIR` connect `Parser Combinators` to `GotoNode`, `Z80 Codegen & IR Base`, `Object File & Relocations`, `BinaryOpNode`?**
