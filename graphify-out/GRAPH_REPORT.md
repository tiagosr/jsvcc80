...
## Corpus Check
- 167 files · ~179,144 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1390 nodes · 2614 edges · 111 communities (62 shown, 49 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 6 edges (avg confidence: 0.83)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `2fa8ce9f`
...
Cohesion: 0.04
Nodes (21): AnnotatedDeclNode, AttributeNode, BinaryOpNode, CaseClauseNode, EnumNode, EnumValueNode, ExprStmtNode, FunctionPointerCallNode (+13 more)
...
Cohesion: 0.07
Nodes (22): makeLocation(), AllocStackInstruction, BinaryOpInstruction, CallIndirectInstruction, CallInstruction, DerefLoadInstruction, DerefStoreInstruction, FreeStackInstruction (+14 more)
...
Cohesion: 0.15
Nodes (12): createCrt0(), getCrt0Size(), resolveCrt0Relocations(), link(), ObjectFile, ObjectRelocation, ObjectSection, ObjectSymbol (+4 more)
...
Cohesion: 0.06
Nodes (25): Archive, ArchiveMember, createArchive(), deserializeArchive(), isArchive(), loadArchive(), saveArchive(), serializeArchive() (+17 more)
...
Cohesion: 0.06
Nodes (22): Registers, AstToIr, CPegParser, buildStructTypeRef(), buildTypeSpecifier(), createFunctionPointerType(), createTypeSpec(), kw() (+14 more)
...
## Knowledge Gaps
- **78 isolated node(s):** `✅ Completed`, `🔄 In Progress`, `🔜 Next Steps`, `📔 Backlog (issues identified during implementation for later priorization)`, `TypeInfos` (+73 more)
...
- **Why does `Z80Codegen` connect `Z80 Code Generator` to `Z80 Codegen & IR Base`, `cparser.js`?**
  _High betweenness centrality (0.031) - this node is a cross-community bridge._
- **Why does `DirectiveHandler` connect `IR to Object File` to `cparser.js`?**
