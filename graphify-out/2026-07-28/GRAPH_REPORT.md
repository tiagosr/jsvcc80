...
## Corpus Check
- 153 files · ~152,247 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1294 nodes · 2648 edges · 94 communities (56 shown, 38 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 6 edges (avg confidence: 0.83)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `52c50887`
...
Cohesion: 0.04
Nodes (24): AddressOfNode, AnnotatedDeclNode, AttributeNode, BinaryOpNode, CallNode, CaseClauseNode, CompoundNode, ControlFlowNode (+16 more)
...
Cohesion: 0.09
Nodes (73): alt(), any(), lazy(), lit(), LocationParser, many(), map(), MapParser (+65 more)
...
Cohesion: 0.11
Nodes (3): CallAndMemoryTranslator, extractCallingConventionFromAttributes(), TranslationContext

### Community 38 - "EnumValueNode"
Cohesion: 0.11
Nodes (4): IntrinsicHandler, IntrinsicMap, TranslationState, compileToAssembly()

### Community 40 - "GotoNode"
Cohesion: 0.06
Nodes (15): EnumValueNode, GotoNode, JumpNode, LabelNode, LiteralNode, PointerMemberNode, PragmacNode, StructFieldNode (+7 more)
...
Cohesion: 0.06
Nodes (8): CompilerOptions, PassManager, globalRegistry, PluginRegistry, CalleeAttributeHandler, CdeclAttributeHandler, FastcallAttributeHandler, NewSdccAttributeHandler
...
- **Why does `Z80Codegen` connect `Z80 Code Generator` to `GotoNode`, `objectfile_loader.js`, `EnumValueNode`, `CaseClauseNode`?**
  _High betweenness centrality (0.050) - this node is a cross-community bridge._
- **Why does `Linker` connect `WLA DX Codegen` to `Object File & Relocations`, `objectfile_loader.js`, `Linker Core`?**
  _High betweenness centrality (0.045) - this node is a cross-community bridge._
- **Why does `LexerCore` connect `Link Result` to `CompoundNode`?**
